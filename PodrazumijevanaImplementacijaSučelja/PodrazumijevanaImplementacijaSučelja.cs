namespace Vsite.CSharp.Sučelja
{
    internal class PodrazumijevanaImplementacijaSučelja
    {
        ...
        // U IPlivajući dodati implementaciju metode Plivaj tako da ispiše "On bi i plivo!".
        ...
        static void Main(string[] args)
        {
            ...
            osoba.Hodaj();
            //  Pozvati na osobi metodu Plivaj. Što treba napraviti da bi se ona doista pozvala.
