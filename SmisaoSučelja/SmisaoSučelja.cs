...
namespace Vsite.CSharp.Sučelja
{
    class SmisaoSučelja
    {
        ...
        public static void SortiranoPoMjestuRođenja(List<Osoba> osobe)
        {
            ...
            osobe.Sort(new SortiranoPoMjestuRođenja());
        }
    ...
    internal class SortiranoPoMjestuRođenja : IComparer<Osoba>
    {
        public int Compare(Osoba x, Osoba y)
        {
            return string.Compare(x.MjestoRođenja, y.MjestoRođenja, true);
        }
    }
}
