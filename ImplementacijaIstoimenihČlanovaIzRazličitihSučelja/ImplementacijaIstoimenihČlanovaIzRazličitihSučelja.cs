...
namespace Vsite.CSharp.Sučelja
{
    class ImplementacijaIstoimenihČlanovaIzRazličitihSučelja
    {
        ...
        // TODO:050 U implementaciju metode Skoči u klasi Desetobojac napisati naredbu koja će ispisati "Hop". 
        //U metodi Main pozvati tu metodu, pokrenuti program i provjeriti ispis.
        ...
        public class Desetobojac:ISkokUvis,ISkokUdalj      //dodano ISkokUVis, ISkokUDalj
        {
            public void Skoči()
            {
                Console.WriteLine("Hop");   //novo dodano
            }
            void ISkokUvis.Skoči()      //  novo dodano
            {
                Console.WriteLine("Hop u vis");
            }
            void ISkokUdalj.Skoči()      //  novo dodano
            {
        ...
        static void Main(string[] args)
        {
            ...
            db.Skoči(); //novo dodano
            ((ISkokUvis)db).Skoči();    //novo dodano
            ((ISkokUdalj)db).Skoči();    //novo dodano))
