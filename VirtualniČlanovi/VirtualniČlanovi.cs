...
namespace Vsite.CSharp.Sučelja
{
    class VirtualniČlanovi
    {
        ...
        {
            public string NevirtualnaMetoda() { return "Bazna.NevirtualnaMetoda"; }
            public virtual string VirtualnaMetoda() { return "Bazna.VirtualnaMetoda"; }
        }
        ...
        {
            public new string NevirtualnaMetoda() { return "Izvedena.NevirtualnaMetoda"; }
            public override string VirtualnaMetoda() { return "Izvedena.VirtualnaMetoda"; }
        }
