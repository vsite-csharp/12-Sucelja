...
namespace Vsite.CSharp.Sučelja
{
    class VirtualniČlanovi
    {
        ...
        public class Bazna : ISučelje //implementira ISucelje
        {
        ...
        {
            public new string NevirtualnaMetoda() // fali new da bi se maknula greška
            {
                return "Izvedena.NevirtualnaMetoda";
            }

            public override string VirtualnaMetoda() // umjesto virtual - override
            {
